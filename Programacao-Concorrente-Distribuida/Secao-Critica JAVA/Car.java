...
public class Car implements Runnable{
    ...
    public Car(int cartype,Car inFront, Image image, TrafficController controller) {
        ...
        if (cartype == REDCAR) xpos = inFront==null ? outRight : Math.min(initX[cartype],inFront.getX()-90);
	    else xpos = inFront == null ? outLeft : Math.max(initX[cartype],inFront.getX()+90);
